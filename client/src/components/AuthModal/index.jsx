  ...
  return (
    <>
      <button className="get-started-button" onClick={handleShow}>
        {buttonLabel}{" "}
        {showPlaneIcon && (
          <FontAwesomeIcon icon={faPlane} style={{ marginLeft: "5px" }} />
        )}
      </button>
          ...
          <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                      ...
                      <>
                        ...
                        <div>
                          <div className="flex items-center justify-between">
                            <label
                              htmlFor="password"
                              className="block text-sm font-primaryleading-6 text-gray-900"
                            >
                              Password
                            </label>
                          </div>
                        ...
                        <div>
                          <button
                            type="submit"
                            className="mt-10 flex w-full justify-center rounded-md bg-theme-blue px-3 py-1.5 text-sm font-primary leading-6 text-white shadow-sm hover:opacity-75"
                          >
                            Sign in
                          </button>
                        </div>
              ...
              <p className="mt-10 font-primary text-center text-sm text-gray-500">
                ...
                <button
                  className="leading-6 text-theme-blue hover:opacity-75"
                  onClick={toggleForm}
                >
