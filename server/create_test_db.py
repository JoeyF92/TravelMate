...
def add_entries():
    ...
    user4 = User(first_name="Josh", last_name="Murray", email="jm@travelmate.com", username="josh", password="$2b$10$Qq67VLNhhfDIZ/yCLs0zv.QOXZOA5rhQ6MOPCEoQ5ceWSHdd9qwSi", profile_pic="")
    user5 = User(first_name="Marcell", last_name="Batta", email="mb@travelmate.com", username="marcell", password="$2b$10$hkCuPS6ceTvZl.9jDGZhiOcnBGkKw5XCSmfEezBqTR6yXZkpZh0li", profile_pic="")
    ...
    packinglist18 = PackingList( items="passport", item_status =False,user_id=5)
    packinglist19 = PackingList( items="clothing", item_status =False,user_id=5)
    packinglist20 = PackingList( items="toiletries", item_status =False,user_id=5)
    packinglist21 = PackingList( items="wallet", item_status =False,user_id=5)
